...
#ifndef VoodooNTRGDevice_h
#define VoodooNTRGDevice_h
...
#define NTRG_PEN_DOWN 0x21
#define NTRG_FINGERTOUCH 0x03
#define NTRG_PENINPUT 0x06
#define NTRG_SINGLETOUCH 0x01
#define NTRG_TWOTOUCH 0x02
#define NTRG_THREETOUCH 0x03
#define NTRG_FOURTOUCH 0x04

#define NTRG_FINGER_DATA_OFFSET 5
// #define NTRG_TOUCH_INFO_OFFSET 6
#define NTRG_HOVER_INFO_OFFSET 5
#define NTRG_MAX_FINGERS 10 //byte 25
#define NTRG_FINGER_DATA_LEN 26
#define NTRG_MAX_INPUT_LEN 31

#define NTRG_TIP_SWITCH 1 //bit 0000 0001
#define NTRG_IN_RANGE 2 //bit 0000 0010
#define NTRG_CONFIDENCE 4 //bit 0000 0100 hardware issue?  always set?

#define KBD_LCONTROL_BIT 1

class VoodooI2C;
class VoodooNTRGWrapper;
class IOBufferMemoryDescriptor;

class VoodooNTRGDevice : public VoodooI2CDevice
{
    typedef IOService super;
    OSDeclareDefaultStructors(VoodooNTRGDevice);
    
private:
    CSGesture* _wrapper;
    VoodooNTRGWrapper* _wacwrapper;
...
.registerIndex = offsetof(struct i2c_hid_desc, wCommandRegister)
    ...
    uint8_t report[NTRG_MAX_INPUT_LEN];
